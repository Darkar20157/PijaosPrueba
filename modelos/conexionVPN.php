<?php
    ...
    class ConexionVpn {
        ...
        private function __construct() {
            ...
            $this->_sServidor = 'mtxscanb';
            $this->_sNombreBD = 'APERTURAS_CIERRES';
            $this->_sUsuario = 'ADUCUARA';
            $this->_sClave = 'Aducu4r4*2022*';
            $this->_sPuerto = '1521';
        }
         ...
         * @return resource
         */
        public static function getInstanciaVpn() {
        ...
        private function conectar() {
            ...
            if (is_resource($this->_oLinkId)) {
                //self::$sMensaje = "Conexion exitosa (SERVER) !<br/>";
            } else {
